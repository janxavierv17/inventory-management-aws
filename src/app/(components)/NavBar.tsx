			...
			<div className="flex justify-between items-center gap-5">
				<div className="hidden md:flex justify-between items-center gap-5">
					...
					<div className="relative">
						...
						<span className="absolute -top-2 -right-2 inline-flex items-center justify-center px-[0.35rem] text-xs font-semibold loading-none text-red-100 bg-red-400 rounded-full">
							3
						</span>
					</div>
					...
					<div className="flex items-center gap-3 cursor-pointer">
						<div className="w-9 h-9">
							<span className="font-semibold">Jan Xavier</span>
						</div>
					</div>
				</div>
